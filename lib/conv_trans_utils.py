...
class BasicTransBlock(nn.Module):
    ...
    def __init__(self, in_ch, heads, dim_head, attn_drop=0., proj_drop=0., reduce_size=8, projection='interp', rel_pos=True):
        super().__init__()
...
class BasicTransDecoderBlock(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, heads, dim_head, attn_drop=0., proj_drop=0., reduce_size=8, projection='interp', rel_pos=True):
        super().__init__()
...
class LinearAttention(nn.Module):
    ...
    def __init__(self, dim, heads=4, dim_head=64, attn_drop=0., proj_drop=0., reduce_size=8, projection='interp', rel_pos=True):
        super().__init__()
...
class LinearAttentionDecoder(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, heads=4, dim_head=64, attn_drop=0., proj_drop=0., reduce_size=8, projection='interp', rel_pos=True):
        super().__init__()
...
class RelativePositionBias(nn.Module):
    ...
    def forward(self, H, W):
        # print(self.relative_position_index.view(-1).shape)
...
class down_block_trans(nn.Module):
    def __init__(self, in_ch, out_ch, num_block, bottleneck=False, maxpool=True, heads=4, dim_head=64, attn_drop=0., proj_drop=0., reduce_size=8, projection='interp', rel_pos=True):
...
class up_block_trans(nn.Module):
    def __init__(self, in_ch, out_ch, num_block, bottleneck=False, heads=4, dim_head=64, attn_drop=0., proj_drop=0., reduce_size=8, projection='interp', rel_pos=True):
        super().__init__()
...
class block_trans(nn.Module):
    def __init__(self, in_ch, num_block, heads=4, dim_head=64, attn_drop=0., proj_drop=0., reduce_size=8, projection='interp', rel_pos=True):
